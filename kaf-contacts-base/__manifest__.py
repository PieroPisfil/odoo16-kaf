...

{
    ...
    #         'kaf-contacts-base/static/src/js/Screens/PartnerListSrceen/*',
            ...
            'kaf-contacts-base/static/src/js/Screens/PartnerListScreen/PartnerLine.js',
            'kaf-contacts-base/static/src/xml/Screens/PartnerListScreen/PartnerLine.xml',
            'kaf-contacts-base/static/src/js/Screens/PartnerListScreen/PartnerListScreen.js',
            'kaf-contacts-base/static/src/xml/Screens/PartnerListScreen/PartnerListScreen.xml',
        ],
    },
    'license': 'LGPL-3',
    'installable': True,
